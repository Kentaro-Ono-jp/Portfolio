...
creates, updates, detaches, or deletes IAM objects.
...
2. In IAM **Policies**, create the eleven customer-managed policies named by
...
8. Verify that the operator has exactly the three identity policies listed by
...
10. When a checked-in policy document changes, create a new customer-managed
