...
<!-- docforai-rule: publication-workflow -->
...
2. Use [live-state exact checks](../reference/live-state.md), return here, and
...
[machine-qualified Markdown-only CI exception](../ci/markdown-only.md), read
...
- Approved exact head with required proof: open [merge](merge.md).
