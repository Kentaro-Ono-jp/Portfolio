...
1. Use [live-state exact checks](../reference/live-state.md), return here, and
...
5. For a Markdown-only squash, read the
   [exception's squash boundary](../ci/markdown-only.md#squash-merge-boundary),
