...
<!-- docforai-rule: implementation-workflow -->
...
7. If a required local tool is missing, read
   [local tool authorization](../reference/local-tools.md), then return here.
...
10. Enter the [CI router](../../../.github/workflows/CI_PLAYBOOK.md) and select
