...
| RabbitMQ 4.3 rejected transient non-exclusive Celery control, event, then unused cluster queues. | Deprecated topology survived in three layers. Make transient control/event queues exclusive and disable unused gossip/mingle rather than weakening broker policy. | [`celery_app.py`](../../apps/ml/src/reactorfront_ml/celery_app.py), [`compose.yaml`](../../compose.yaml), and [`check_ml_compose_boundary.py`](../../scripts/check_ml_compose_boundary.py) | PR #8 [failed runs 29672715519](https://github.com/Kentaro-Ono-jp/Portfolio/actions/runs/29672715519), [29673187660](https://github.com/Kentaro-Ono-jp/Portfolio/actions/runs/29673187660), and [29673641464](https://github.com/Kentaro-Ono-jp/Portfolio/actions/runs/29673641464); fixes [`640ddbd`](https://github.com/Kentaro-Ono-jp/Portfolio/commit/640ddbd9fc9dadc864cbc9d72c85ed8ff16135ab), [`674fd1b`](https://github.com/Kentaro-Ono-jp/Portfolio/commit/674fd1b5e96e0e700b2e06b284395671cecf28aa), and [`1826afd`](https://github.com/Kentaro-Ono-jp/Portfolio/commit/1826afd4cea1ac3eda2595e0db983f49cc9a37a4); [successful run 29674130187](https://github.com/Kentaro-Ono-jp/Portfolio/actions/runs/29674130187). |
